import { type Experience } from '@/app/config/Experience';
import { cn } from '@/app/lib/utils';
import { Link } from 'next-view-transitions';
import Image from 'next/image';
import Skill from '../components/common/Skill';
import Github from '../components/svgs/Github';
import LinkedIn from '../components/svgs/Github';
import Website from "../components/svgs/Github";
import X from '../components/svgs/Github';
    ...
    <div className="flex flex-col gap-4">
      ...
      <div>
        ...
        <div className="flex flex-wrap gap-2">
          {experience.techs.map((technology, techIndex: number) => (
            <Skill
              key={techIndex}
