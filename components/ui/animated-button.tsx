...
const { asChild, ...restProps } = rest;
    return (
        <Component
            ...
            className={cn(
                "group inline-flex items-center justify-center px-4 py-2 rounded-md relative overflow-hidden bg-neutral-50 dark:bg-black border border-neutral-200 dark:border-neutral-800",
