...
//     filter: "blur(0px)",
//     transition: {
//       type: "tween" as const,  // ✅ Tween type
//       duration: 0.6,
//       ease: "easeOut",         // ✅ Replace bounce with ease
//     },
//   },
// };
...
//                 onClick={playSound}
//                 whileHover={{ scale: 1.1, rotate: 10 }} // Add hover effect
//                 whileTap={{ scale: 0.9 }}
//               >
//                 {icons}
//               </motion.span>
  ...
  return (
    <Container className="mx-auto max-w-5xl">
      ...
      >
        ...
        <motion.div 
          variants={itemVariants} 
          className="relative flex shrink-0 overflow-hidden rounded-xl rotate-0 hover:-rotate-6 transition-all duration-300 border-neutral-300/60 dark:border-white/20 bg-neutral-200 size-24 border p-1 hover:p-2"
        >
          <Image
            src={avatar}
            alt="hero"
